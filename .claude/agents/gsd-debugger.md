...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/bill/source/DoML/.claude
                  → checks /home/bill/source/DoML/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/bill/source/DoML/.claude/get-shit-done
                  → writes to /home/bill/source/DoML/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/home/bill/source/DoML/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/bill/source/DoML/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/bill/source/DoML/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
