...
Reference full template: `/home/bill/source/DoML/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/bill/source/DoML/.claude/get-shit-done/templates/state.md`.
