...
<reference>
@/home/bill/source/DoML/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/bill/source/DoML/.claude/get-shit-done/references/user-profiling.md` to load:
