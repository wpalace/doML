...
<details>
<summary>✅ <strong>v1.5 Public Release + Install Scripts</strong> (Phases 19, 20, 21) — SHIPPED 2026-04-30</summary>
...
- [x] **Phase 19: Public Release Docs** — README.md, LICENSE, FUNDING.yml (1/1 plan; SUMMARY/VERIFICATION skipped — see audit)
- [x] **Phase 20: Install Scripts — Claude Target** — `install.sh` + `install.ps1` (2/2 plans; SUMMARY/VERIFICATION skipped — see audit)
- [x] **Phase 21: Copilot Support + `--target` Flag** — AGENTS.md, copilot install branch (2/2 plans; SUMMARY + VERIFICATION present)

Full phase details, success criteria, and plans: [milestones/v1.5-ROADMAP.md](milestones/v1.5-ROADMAP.md)
Audit report: [milestones/v1.5-MILESTONE-AUDIT.md](milestones/v1.5-MILESTONE-AUDIT.md)
Archived requirements: [milestones/v1.5-REQUIREMENTS.md](milestones/v1.5-REQUIREMENTS.md)
...
Plans:
- [x] 18-01-PLAN.md — SKILL.md entry point + iterate-deployment.md workflow (13 steps: leaderboard guard, version scan, --target/--guidance flag parsing, target delegation, verbatim Step 12 performance report)
